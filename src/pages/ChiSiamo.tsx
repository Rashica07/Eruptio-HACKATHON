...
const TEAM = [
  ...
  },
  {
    ...
    kanji: "知",
    accent:"bg-[#0a1a2d]",
    contribution: "Ha condotto la ricerca sulle destinazioni vulcaniche, i testi del sito, gli itinerari e la logistica del viaggio Tokyo.",
  },
];
    ...
    <div className="min-h-screen bg-background topo-pattern pt-32 pb-24">
      <div className="max-w-[var(--max)] mx-auto px-[var(--gutter)]">
        ...
        <div className="text-center mb-24">
          ...
          >
            Siamo un team di sei esploratori digitali uniti da una passione comune: trasformare l'ordinario in straordinario. Eruptio è il frutto del nostro lavoro all'Hackathon 2026.
          </motion.p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 mb-32">
          {TEAM.map((member, idx) => (
            <motion.div
              ...
              className="bg-card border border-clay rounded-2xl overflow-hidden group hover:border-moss/40 hover:shadow-2xl hover:shadow-moss/5 transition-all duration-500"
            >
              {/* Avatar area */}
              <div className={`${member.accent} h-52 flex items-center justify-center relative overflow-hidden`}>
                ...
                <div className="relative z-10 w-28 h-28 rounded-full overflow-hidden border-4 border-white/20 shadow-2xl group-hover:scale-105 transition-transform duration-500">
                  <img
                ...
                <div className="absolute bottom-3 right-3 w-9 h-9 rounded-full bg-white/10 backdrop-blur-sm flex items-center justify-center font-display text-lg text-white/70">
                  {member.kanji}
                </div>
              </div>
              ...
              <div className="p-7 flex flex-col gap-3">
                ...
                <h3 className="font-display italic uppercase text-xl tracking-tight text-moss leading-tight mt-1">
                  {member.role}
                </h3>
        ...
        <div className="border-t border-clay/40 pt-20 mb-24">
          <div className="text-center mb-16">
            ...
            <BlurText
              text="Cosa ci muove."
              className="font-display italic text-4xl md:text-7xl leading-[0.9] tracking-tight text-ink uppercase mt-6"
            />
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
            {VALUES.map((v, idx) => (
              <motion.div
                ...
                className="bg-card border border-clay rounded-2xl p-10 text-center hover:border-moss/30 transition-colors group"
              >
                <div className="font-display text-6xl text-moss/20 mb-4 group-hover:text-moss/40 transition-colors">{v.kanji}</div>
                <h4 className="font-display italic uppercase text-2xl tracking-tight text-ink mb-3">{v.label}</h4>
        ...
        >
          ...
          <h3 className="font-display italic uppercase text-4xl md:text-6xl tracking-tight mb-6 mt-2">
            Da Lecco a Tokyo
          </h3>
