...
export function Hero() {
  return (
    <section id="hero" className="relative min-h-[90vh] flex items-center justify-center pt-32 pb-20 bg-bg topo-pattern overflow-hidden">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 flex items-center justify-center opacity-[0.03] pointer-events-none select-none">
      ...
      <div className="relative z-10 max-w-[var(--max)] mx-auto px-[var(--gutter)] flex flex-col items-center text-center">
        ...
        >
          <span className="pill mb-8">Destinazione Premium // 2026</span>
        </motion.div>
