...
export const DESTINATIONS: Record<string, Destination> = {
  ...
  "vesuvio": {
    ...
    gallery: [
      "/images/destinations/vesuvio.jpg",
  ...
  "stromboli": {
    ...
    img: "/images/destinations/stromboli.jpg",
    gallery: [
      "/images/destinations/stromboli.jpg",
      u("photo-1559592413-7cec4d0cae2b", 800),
    ],
