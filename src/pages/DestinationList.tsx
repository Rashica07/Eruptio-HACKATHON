      ...
      <div className="max-w-[var(--max)] mx-auto px-[var(--gutter)]">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5">
          {filtered.map((dest, idx) => (
            <motion.div
              ...
              className={cn(
                "group bg-card border rounded-2xl overflow-hidden flex flex-col hover:shadow-2xl hover:shadow-moss/5 transition-all duration-300",
            ...
            >
              ...
              <div className="relative h-48 overflow-hidden">
                ...
                <div className="absolute top-3 right-3 h-8 w-8 bg-white/10 backdrop-blur-md rounded-full flex items-center justify-center text-white opacity-0 group-hover:opacity-100 transition-all">
              ...
              <div className="p-6 flex flex-col flex-1">
                ...
                <p className="text-xs text-ink/40 line-clamp-2 font-medium mb-4 flex-1 leading-relaxed">
                  {dest.desc}
                </p>
                ...
                >
                  ...
                  <div className="text-right">
                    ...
                    <div className="font-display italic text-lg font-bold text-ink/45">{dest.height}</div>
                  </div>
                </Link>
              </div>
            </motion.div>
        ...
        {filtered.length === 0 && (
          <div className="py-32 text-center">
            <p className="font-display italic text-2xl text-ink/25 uppercase tracking-widest">
